                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="single-widget pr-60">
                        <div class="footer-logo pb-25">
                            <a href="index.html"><img src="{{asset('design')}}/img/logo/footer-logo.png" alt="eduhome"></a>
                        </div>
...
<script src="{{asset('design')}}/js/vendor/jquery-1.12.0.min.js"></script>
<script src="{{asset('design')}}/js/bootstrap.min.js"></script>
<script src="{{asset('design')}}/js/jquery.meanmenu.js"></script>
<script src="{{asset('design')}}/js/jquery.magnific-popup.js"></script>
<script src="{{asset('design')}}/js/ajax-mail.js"></script>
<script src="{{asset('design')}}/js/owl.carousel.min.js"></script>
<script src="{{asset('design')}}/js/jquery.mb.YTPlayer.js"></script>
